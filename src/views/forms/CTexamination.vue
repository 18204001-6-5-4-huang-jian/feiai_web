                  ...
                  <el-radio :label="5">其他，请填写
                    <div class="form-inline">
                      <el-form-item label="" prop="maOtherValue" v-if="form.maValue == 5">
                        <el-input v-model.trim="form.maOtherValue" :disabled="disabledShowState" placeholder="" :size="$store.state.style.assemblyModel" style="width: 200px;"
                          ...
                          <div class="form-inline">
                            <el-form-item label="" prop="minMaOtherValue" v-if="form.minMaValue == 4">
                              <el-input v-model.trim="form.minMaOtherValue" ref="minMaOtherValue" placeholder=""
                                        :disabled="disabledShowState" :size="$store.state.style.assemblyModel" style="width: 200px;"></el-input>
                            </el-form-item>
                          </div>
                          <div class="form-inline">
                    ...
                    <div class="form-inline">
                      <el-form-item label="" prop="slewTimeOther" v-if="form.slewTime == 5">
                        <el-input v-model.trim="form.slewTimeOther" ref="slewTimeOther" placeholder=""
                                  :disabled="form.slewTime != 5" :size="$store.state.style.assemblyModel" style="width: 200px;"></el-input>
                      </el-form-item>
                    </div>
                    <div class="form-inline">
                            ...
                            <el-radio-group v-model="form.flabImageDeep" @change="deepChange('flabImageDeep','flabImageDeepOther')" :disabled="disabledShowState">
                              ...
                              <span>
                                 <el-form-item label="" prop="flabImageDeepOther"  style="display: inline-block;" :inline-message="true" v-if="form.flabImageDeep === '0'">
                                    <el-input v-model.trim="form.flabImageDeepOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                          ...
                          <el-radio-group v-model="form.flabReconstructionDeep" @change="deepChange('flabReconstructionDeep','flabReconstructionDeepOther')" :disabled="disabledShowState">
                            ...
                            <span>
                                 <el-form-item label="" prop="flabReconstructionDeepOther"  style="display: inline-block;" :inline-message="true" v-if="form.flabReconstructionDeep === '0'">
                                    <el-input v-model.trim="form.flabReconstructionDeepOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                          ...
                          <el-radio-group v-model="form.flabImageShallow"  @change="deepChange('flabImageShallow','flabImageShallowOther')"  :disabled="disabledShowState">
                            ...
                            <span>
                                   <el-form-item label="" prop="flabImageShallowOther"  style="display: inline-block;" :inline-message="true" v-if="form.flabImageShallow === '0'">
                                      <el-input v-model.trim="form.flabImageShallowOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                          ...
                          <el-radio-group v-model="form.flabReconstructionShallow"  @change="deepChange('flabReconstructionShallow','flabReconstructionShallowOther')"  :disabled="disabledShowState">
                            ...
                            <span>
                                 <el-form-item label="" prop="flabReconstructionShallowOther"  style="display: inline-block;" :inline-message="true" v-if="form.flabReconstructionShallow === '0'">
                                    <el-input v-model.trim="form.flabReconstructionShallowOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                            ...
                            <el-radio-group v-model="form.lungImageDeep"  @change="deepChange('lungImageDeep','lungImageDeepOther')"  :disabled="disabledShowState">
                              ...
                              <span>
                                   <el-form-item label="" prop="lungImageDeepOther"  style="display: inline-block;" :inline-message="true" v-if="form.lungImageDeep === '0'">
                                      <el-input v-model.trim="form.lungImageDeepOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                            ...
                            <el-radio-group v-model="form.lungReconstructionDeep"  @change="deepChange('lungReconstructionDeep','lungReconstructionDeepOther')"  :disabled="disabledShowState">
                              ...
                              <span>
                                   <el-form-item label="" prop="lungReconstructionDeepOther"  style="display: inline-block;" :inline-message="true" v-if="form.lungReconstructionDeep === '0'">
                                      <el-input v-model.trim="form.lungReconstructionDeepOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                          ...
                          <el-radio-group v-model="form.lungImageShallow" @change="deepChange('lungImageShallow','lungImageShallowOther')"  :disabled="disabledShowState">
                            ...
                            <span>
                                 <el-form-item label="" prop="lungImageShallowOther"  style="display: inline-block;" :inline-message="true" v-if="form.lungImageShallow === '0'">
                                    <el-input v-model.trim="form.lungImageShallowOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                          ...
                          <el-radio-group v-model="form.lungReconstructionShallow"  @change="deepChange('lungReconstructionShallow','lungReconstructionShallowOther')"  :disabled="disabledShowState">
                            ...
                            <span>
                                 <el-form-item label="" prop="lungReconstructionShallowOther"  style="display: inline-block;" :inline-message="true" v-if="form.lungReconstructionShallow === '0'">
                                    <el-input v-model.trim="form.lungReconstructionShallowOther" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                  ...
                  <td>
                    <p>
                      <el-form-item label="" prop="ctdlvol">
                        <el-input v-model.trim="form.ctdlvol" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                                  style="width: 80px;" ref="ctdlvol"></el-input>
                      </el-form-item>
                    </p>
                  </td>
                </tr>
                  ...
                  <td>
                    <p>
                      <el-form-item label="" prop="dlp">
                        <el-input v-model.trim="form.dlp" :disabled="disabledShowState" :size="$store.state.style.assemblyModel" style="width: 80px;"
                                  ref="dlp"></el-input>
                      </el-form-item>
                    </p>
                  </td>
        ...
        <div class="formcon">
          ...
          <div class="form-body-content">
            ...
            <div v-if="form.tubercle == 1">
              <el-row>
                <el-col :span="24">
                  <el-form-item label="2. 是否所有结节均＜5mm（不包括含肯定良性钙化成份的结节或肿块）？" prop="tubercleLessFive" labelWidth="600px"
                                class="form-item">
                    <br>
              ...
              <div v-if="form.tubercleLessFive == 2">
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="3. 结节是否≥5mm（不包括含肯定良性钙化成份的结节或肿块）？" prop="tubercleGreaterFive" labelWidth="520px"
                                  class="form-item">
                      <br>
                ...
                <el-row>
                  <el-col :span="24" v-if="form.tubercleGreaterFive == 1">
                    <div style="margin-left: 40px;">
                      <el-form-item label="检出≥5mm结节的数量：（请按结节从大到小顺序填写）" prop="item8_3" labelWidth="430px"
                                    class="form-item">
                        <br>
                            ...
                            <div class="form-inline">
                              <el-form-item label="" prop="lessTenCount" class="form-item1"
                                ...
                                <el-input v-model.trim="form.lessTenCount" @input="addTableTubercleList()"
                                          placeholder="" :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                            ...
                            <div class="form-inline">
                              <el-form-item label="" prop="" class="form-item1" style="display: inline-block;"
                                ...
                                <el-input v-model.trim="form.lessTenCount" placeholder=""
                                          disabled :size="$store.state.style.assemblyModel" style="width: 80px;"></el-input>
                              </el-form-item>
                            </div>
                ...
                <el-row>
                  <div class="div" v-if="countState">
                    <table class="ctTubercleInfoPOList-table">
                      <tr>
                        <td class="ctTubercleInfoPOList-table-title">
                          ...
                          <p style="height: 300px;" class="tabled-td-bt">
                            结节处理建议<br>
                            <span>1. 年度复查</span><br>
                        ...
                        <td v-for="(item,index) in form.ctTubercleInfoPOList" :key="index"
                          ...
                          <p class="tabled-td-anatomicalPosition ">
                            <el-form-item label="" :prop="'ctTubercleInfoPOList.'+index+'.anatomicalPosition'"
                              ...
                              <el-input v-model.trim="item.anatomicalPosition" placeholder=""
                                        ...
                                        :disabled="disabledShowState" :size="$store.state.style.assemblyModel" style="width: 50px;"></el-input>
                            </el-form-item>
                          </p>
                          ...
                          <p class="tabled-td-densityOther">
                            <el-form-item label="" :prop="'ctTubercleInfoPOList.'+index+'.densityOther'"
                              ...
                              <el-checkbox-group v-model="item.densityOther" :disabled="disabledShowState">
                                ...
                                <el-checkbox label="6">液体/水样</el-checkbox>
                              </el-checkbox-group>
                            </el-form-item>
                          </p>
                          <p>
                              ...
                              <span>
                                <el-form-item label="" :prop="'ctTubercleInfoPOList.'+index+'.trueDiameter'"
                                  ...
                                  <el-input v-model.trim="item.trueDiameter" placeholder="" @blur="countToFixed3(item)"
                                            :ref="'ctTubercleInfoPOList.'+index+'.volume'"
                                            :disabled="disabledShowState" :size="$store.state.style.assemblyModel"
                              ...
                              <span>
                                <el-form-item label="" :prop="'ctTubercleInfoPOList.'+index+'.trueMinorAxis'"
                                  ...
                                  <el-input v-model.trim="item.trueMinorAxis" placeholder="" @blur="countToFixed4(item)"
                                            ...
                                            :disabled="disabledShowState" :size="$store.state.style.assemblyModel" style="width: 200px;"
                    ...
                    <table class="all-idea-table">
                      <tr>
                        <td class="all-idea-table-title">结节处理意见
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="1. 本次扫描是否检出其他异常情况？" prop="abnormalStatus" labelWidth="430px" class="form-item">
                  <br>
                  <el-radio-group v-model="form.abnormalStatus" :disabled="disabledShowState">
                  ...
                  <tr>
                    <td>
                      <el-form-item prop="abnormalT" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalT" :disabled="disabledShowState">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                      <p class="form-index-checkbox" v-if="form.abnormalT == 1">
                        ...
                        <el-form-item prop="abnormalT5" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalT5"
                                       :disabled="disabledShowState">右主支气管
                          </el-checkbox>
                        </el-form-item>
                        <el-form-item prop="abnormalT6" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalT6"
                                       :disabled="disabledShowState">右上叶支气管
                          </el-checkbox>
                        </el-form-item>
                        <el-form-item prop="abnormalT7" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalT7"
                                       :disabled="disabledShowState">右中叶支气管
                          </el-checkbox>
                        </el-form-item>
                        <el-form-item prop="abnormalT8" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalT8"
                                       :disabled="disabledShowState">右下叶支气管
                          </el-checkbox>
                        </el-form-item>
                        <el-form-item prop="abnormalT2" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalT2"
                                       :disabled="disabledShowState">左主支气管
                          </el-checkbox>
                        </el-form-item>
                        <el-form-item prop="abnormalT3" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalT3"
                                       :disabled="disabledShowState">左上叶支气管
                          </el-checkbox>
                        </el-form-item>
                        <el-form-item prop="abnormalT4" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalT4"
                                       :disabled="disabledShowState">左下叶支气管
                          </el-checkbox>
                        </el-form-item>
                      </p>
                    </td>
                    <td>
                      <el-form-item prop="abnormalR" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalR" :disabled="disabledShowState"
                        ...
                        <p>
                          <el-form-item prop="abnormalR1" labelWidth="430px" class="form-item">
                            <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalR1"
                                         :disabled="disabledShowState">支气管壁增厚
                            </el-checkbox>
                          </el-form-item>
                        ...
                        <p>
                          <el-form-item prop="abnormalR2" labelWidth="430px" class="form-item">
                            <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalR2"
                                         :disabled="disabledShowState">树芽征”样病灶
                            </el-checkbox>
                          </el-form-item>
                        </p>
                        <p>
                          <el-form-item prop="abnormalR3" labelWidth="430px" class="form-item">
                            <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalR3"
                                         :disabled="disabledShowState">支气管扩张
                            </el-checkbox>
                          </el-form-item>
                        </p>
                        <p>
                          <el-form-item prop="abnormalR4" labelWidth="430px" class="form-item">
                            <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalR4"
                                         :disabled="disabledShowState">弥漫性“马赛克”样改变
                            </el-checkbox>
                          </el-form-item>
                        </p>
                        <p>
                          <el-form-item prop="abnormalR5" labelWidth="430px" class="form-item">
                            <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalR5"
                                         :disabled="disabledShowState">粘液栓塞
                            </el-checkbox>
                          </el-form-item>
                        </p>
                        <p>
                          <el-form-item prop="abnormalR6" labelWidth="430px" class="form-item">
                            <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalR6"
                                         :disabled="disabledShowState">空气潴留（呼气性）
                            </el-checkbox>
                          </el-form-item>
                        </p>
                        <p>
                  ...
                  <tr>
                    <td>
                      <el-form-item prop="abnormalL" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalL" :disabled="disabledShowState">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                    ...
                    <td>
                      <el-form-item prop="abnormalJ" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalJ" :disabled="disabledShowState">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                  ...
                  <tr>
                    ...
                    <td>
                      <el-form-item labelWidth="430px" class="form-item" prop="item10_16">
                        ...
                        <el-radio-group v-model="form.item10_16" :disabled="disabledShowState" @change="item10_16Change">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                  ...
                  <tr>
                    <td>
                      <el-form-item prop="abnormalD" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalD" :disabled="disabledShowState">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                    ...
                    <td>
                      <el-form-item labelWidth="430px" class="form-item" prop="abnormalG">
                        ...
                        <!--:disabled="disabledShowState">胸壁异常(骨质破坏、转移等)，请注明-->
                        <!--</el-checkbox>-->
                        <span class="form-span-title">
                          胸壁异常(骨质破坏、转移等)
                        </span>
                        <el-radio-group v-model="form.abnormalG" :disabled="disabledShowState"
                  ...
                  <tr>
                    <td>
                      <el-form-item prop="abnormalE" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalE" :disabled="disabledShowState">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                    ...
                    <td>
                      <el-form-item prop="abnormalA" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalA" :disabled="disabledShowState">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                      <p class="form-index-checkbox" v-if="form.abnormalA==1">
                        ...
                        <el-form-item prop="abnormalA4" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalA4"
                                       :disabled="disabledShowState">3 纵隔血管前和气管后
                          </el-checkbox>
                        </el-form-item>
                  ...
                  <tr>
                    <td>
                      <el-form-item prop="abnormalC" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalC" @change="abnormalCChange" :disabled="disabledShowState">
                          <el-radio :label="1">是</el-radio>
                          <el-radio :label="2">否</el-radio>
                        </el-radio-group>
                      </el-form-item>
                      <div class="form-index-checkbox" v-if="form.abnormalC == 1">
                        ...
                        <el-form-item class="form-item" prop="abnormalC0" :inline-message="true" >
                          <el-radio-group v-model="form.abnormalC0" :disabled="disabledShowState">
                            <el-radio label="1">轻度</el-radio>
                            <el-radio label="2">中度</el-radio>
                            <el-radio label="3">重度</el-radio>
                            <el-radio label="4">难以判断</el-radio>
                    ...
                    <td>
                      <el-form-item prop="abnormalF" labelWidth="430px" class="form-item">
                        ...
                        <el-radio-group v-model="form.abnormalF" :disabled="disabledShowState"
                      ...
                      <p class="form-index-checkbox" v-if="form.abnormalF == 1">
                        ...
                        <el-form-item prop="abnormalF1" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalF1"
                                       :disabled="disabledShowState">主动脉瘤
                          </el-checkbox>
                        </el-form-item>
                        <br>
                        <el-form-item prop="abnormalF2" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalF2"
                                       :disabled="disabledShowState">主动脉夹层
                          </el-checkbox>
                        </el-form-item>
                        <br>
                        <el-form-item prop="abnormalF3" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalF3"
                                       :disabled="disabledShowState">主动脉假性动脉瘤
                          </el-checkbox>
                        </el-form-item>
                        <br>
                        <el-form-item prop="abnormalF5" labelWidth="430px" class="form-item-check">
                          <el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalF5"
                                       :disabled="disabledShowState">主动脉钙化
                          </el-checkbox>
                        </el-form-item>
                  ...
                  <tr>
                    ...
                    <td>
                      <el-form-item labelWidth="430px" class="form-item " prop="abnormalI">
                        ...
                        <el-radio-group v-model="form.abnormalI" :disabled="disabledShowState"
                  ...
                  <tr>
                    ...
                    <td>
                      <el-form-item labelWidth="430px" class="form-item" prop="abnormalK">
                        ...
                        <el-radio-group v-model="form.abnormalK" :disabled="disabledShowState"
                    ...
                    <!--<td>-->
                      <!--<el-form-item prop="abnormalB" labelWidth="430px" class="form-item">-->
                        <!--<span class="form-span-title">-->
                          <!--非特异性间质纤维化-->
                        <!--</span>-->
                        <!--<el-radio-group v-model="form.abnormalB" @change="abnormalBChange" :disabled="disabledShowState">-->
                          <!--<el-radio :label="1">是</el-radio>-->
                          <!--<el-radio :label="2">否</el-radio>-->
                        <!--</el-radio-group>-->
                      <!--</el-form-item>-->
                      <!--<p class="form-index-checkbox" v-if="form.abnormalB==1">-->
                        ...
                        <!--<el-form-item prop="abnormalB2" labelWidth="430px" class="form-item-check">-->
                          <!--<el-checkbox :true-label="1" :false-label="2" v-model="form.abnormalB2"-->
                                       <!--:disabled="disabledShowState">食管旁-->
                          <!--</el-checkbox>-->
                        <!--</el-form-item>-->
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="1. 诊断结果:" prop="diagnosticResult" labelWidth="430px" class="form-item">
                  <br>
                  <el-select v-model="form.diagnosticResult" placeholder="请选择" :size="$store.state.style.assemblyModel" style="width: 500px" :disabled="disabledShowState"
                             clearable>
                    <el-option
  ...
  export default {
    ...
    data () {
      ...
      var validate_item3_1 = (rule, value, callback) => {
        ...
        if (value && !( /^(?=([0-9]{1,10}$|[0-9]{1,12}\.))(0|[1-9][0-9]*)(\.[0-9]{1,3})?$/.test(value))) {
      ...
      var validate_lessTenCount = (rule, value, callback) => {
        if(value>10 || !(/^\d{1,2}$/.test(value))){
          this.countState = false
          callback(new Error('数值（1-10）且为正整数'))
        }else if(value > this.form.tubercleCount/1){
          this.countState = false
          callback(new Error('请输入小于总结节数的数值'))
        }else {
          callback()
      ...
      var validate_greaterTenCount = (rule, value, callback) => {
        if(value<10 || !(/^\d{1,2}$/.test(value))){
          this.countState = false
          callback(new Error('数值（>10）且为正整数'))
        }else if(value > this.form.tubercleCount/1){
          this.countState = false
      ...
      var validate_abnormalC = (rule, value, callback) => {
        if (value == 1) {
          if (this.form.abnormalC_2_1 || this.form.abnormalC_2_2 || this.form.abnormalC_2_3 || this.form.abnormalC_2_4) {
            callback()
          } else {
      ...
      var validate_abnormalC_2_1 = (rule, value, callback) => {
        ...
        } else if (!this.form.abnormalC_2_4 && !this.form.abnormalC_2_2 && !this.form.abnormalC_2_3) {
//          this.form.abnormalC = 2
      ...
      var validate_abnormalC_2_2 = (rule, value, callback) => {
        if (value) {
          this.form.abnormalC = 1
        } else if (!this.form.abnormalC_2_1 && !this.form.abnormalC_2_4 && !this.form.abnormalC_2_3) {
          this.form.abnormalC = 2
        }
        this.$refs.form.validateField('abnormalC');
        callback()
      ...
      var validate_abnormalC_2_3 = (rule, value, callback) => {
        if (value) {
          this.form.abnormalC = 1
        } else if (!this.form.abnormalC_2_1 && !this.form.abnormalC_2_2 && !this.form.abnormalC_2_4) {
          this.form.abnormalC = 2
        }
        this.$refs.form.validateField('abnormalC');
        callback()
      ...
      var validate_abnormalC_2_4 = (rule, value, callback) => {
        if (value) {
          this.form.abnormalC = 1
        } else if (!this.form.abnormalC_2_1 && !this.form.abnormalC_2_2 && !this.form.abnormalC_2_3) {
          this.form.abnormalC = 2
        }
        this.$refs.form.validateField('abnormalC');
        callback()
      ...
      var validate_item10_17_2_5 = (rule, value, callback) => {
        if (value) {
          this.form.item10_17 = 1
        } else if (!this.form.abnormalR4 && !this.form.item10_17_2_2 && !this.form.abnormalC_2_3 && !this.form.item10_17_2_1 && !this.form.item10_17_2_6 && !this.form.item10_17_2_7) {
          this.form.item10_17 = 2
        }
        this.$refs.form.validateField('item10_17');
        callback()
      ...
      var validate_item10_17_2_6 = (rule, value, callback) => {
        if (value) {
          this.form.item10_17 = 1
        } else if (!this.form.abnormalR4 && !this.form.item10_17_2_2 && !this.form.abnormalC_2_3 && !this.form.item10_17_2_1 && !this.form.item10_17_2_5 && !this.form.item10_17_2_7) {
          this.form.item10_17 = 2
        }
        this.$refs.form.validateField('item10_17');
        callback()
      ...
      var validate_item10_17_2_7 = (rule, value, callback) => {
        if (value) {
          this.form.item10_17 = 1
        } else if (!this.form.abnormalR4 && !this.form.item10_17_2_2 && !this.form.abnormalC_2_3 && !this.form.item10_17_2_1 && !this.form.item10_17_2_5 && !this.form.item10_17_2_6) {
          this.form.item10_17 = 2
        }
        this.$refs.form.validateField('item10_17');
        callback()
      ...
      return {
        ...
        formRules: {
          ...
          ctdlvol: [
            {required: true, message: '必填', trigger: 'blur'},
            {validator: validate_tubercleCount, trigger: 'blur'}
          ],
          dlp: [
            {validator: validate_item3_1, trigger: 'blur'},
            {validator: validate_item3_1, trigger: 'change'}
          ],
          reviewCtResult: [
            {required: true, message: '必选', trigger: 'change'},
          ],
          ...
          ctImageScanningReasonOther: [
            {required: true, message: '必选', trigger: 'blur'},
            {required: true, validator: validate_chinese20, trigger: 'blur'},
          ],
          item2: [
            {required: true, message: '必选', trigger: 'change'},
          ],
          ...
          tubercleCount: [
            {required: true, message: '必填', trigger: 'blur'},
            {required: true, validator: validate_tubercleCount1, trigger: 'blur'},
          ],
          tubercleLessFive: [
            {required: true, message: '必选', trigger: 'change'},
          ],
...
//            {validator: validate_density, trigger: 'blur'}
          ...
          abnormalR4: [
            {validator: validate_abnormal_r, trigger: 'change'}
          ],
          abnormalR1: [
            {validator: validate_abnormal_r, trigger: 'change'}
          ],
...
//      },
      ...
      examinationMethodChange(x){
        if (x.examinationMethod == 1 || x.examinationMethod == 2 || x.examinationMethod == 3 || x.examinationMethod == 4) {
          x.classes.push(4)
        ...
        $axios_http({
          ...
          if (res.data.result) {
            ...
            if(res.data.result.flabReconstructionDeep != null){
              this.form.flabReconstructionDeep = res.data.result.flabReconstructionDeep
            }
            ...
            if(res.data.result.flabReconstructionShallow !=null){
              this.form.flabReconstructionShallow = res.data.result.flabReconstructionShallow
            }
            ...
            if(res.data.result.lungReconstructionDeep !=null){
              this.form.lungReconstructionDeep = res.data.result.lungReconstructionDeep
            }
            ...
            if(res.data.result.lungReconstructionShallow !=null){
              this.form.lungReconstructionShallow = res.data.result.lungReconstructionShallow
            }
            ...
            if(res.data.result.flabReconstructionDeepOther != null){
              this.form.flabReconstructionDeepOther = res.data.result.flabReconstructionDeepOther
            }
            if(res.data.result.flabImageShallowOther !=null){
              this.form.flabImageShallowOther = res.data.result.flabImageShallowOther
            }
            if(res.data.result.flabReconstructionShallowOther !=null){
              this.form.flabReconstructionShallowOther = res.data.result.flabReconstructionShallowOther
            }
            ...
            if(res.data.result.lungReconstructionDeepOther !=null){
              this.form.lungReconstructionDeepOther = res.data.result.lungReconstructionDeepOther
            }
            if(res.data.result.lungImageShallowOther !=null){
              this.form.lungImageShallowOther = res.data.result.lungImageShallowOther
            }
            if(res.data.result.lungReconstructionShallowOther !=null){
              this.form.lungReconstructionShallowOther = res.data.result.lungReconstructionShallowOther
            }
//            if(res.data.result.ctdlvol !=null){
//              this.form.ctdlvol = res.data.result.ctdlvol
//            }
//            if(res.data.result.dlp !=null){
//              this.form.dlp = res.data.result.dlp
//            }
        ...
        this.$refs[formName].validate((valid, obj) => {
          ...
          if (valid) {
            ...
            if (this.form.ctTubercleInfoPOList.length > 0) {
              console.log(this.form.ctTubercleInfoPOList)
              for (let i = 0; i < this.form.ctTubercleInfoPOList.length; i++) {
                this.form.ctTubercleInfoPOList[i].densityOther = this.form.ctTubercleInfoPOList[i].densityOther.join(',')
                this.form.ctTubercleInfoPOList[i].nodularView = this.form.ctTubercleInfoPOList[i].nodularView.join(',')
                this.form.ctTubercleInfoPOList[i].nodularBiopsy = this.form.ctTubercleInfoPOList[i].nodularBiopsy.join(',')
              }
            }
            if (this.form.abnormalR4 = true) {
            ...
            $axios_http({
              ...
              this.$router.replace({path: '/form/CTexaminationReport1', query: {areaId: res.data.result, type: 1}})
            })
          }
        });
      },
      ...
      getCTResult(){
        $axios_http({
          ...
          console.log(this.form.ctTubercleInfoPOList,1)
          ...
          if (this.form.abnormalN1!=null&& this.form.abnormalN1!= '') {
            this.form.abnormalN1 += ''
            this.form.abnormalN = 1
...
//          this.form.tubercleHandlingSuggestion = ''
          ...
          this.form.lessTenCount = ''
          if(this.form.greaterTenCount == ''|| this.form.greaterTenCount == null){
            this.countState = false
          }
//          this.form.ctTubercleInfoPOList = []
//          this.form.tubercleHandlingSuggestion = ''
